...
const Homepage = () => {
  ...
  const courses = [
    ...
    { name: 'CSS', icon: 'fab fa-css3-alt', color: 'from-blue-500 to-teal-500', started: false },
    { name: 'JavaScript', icon: 'fab fa-js', color: 'from-yellow-500 to-orange-500', started: false },
  ...
  const getDeviceId = () => {
    ...
    if (!deviceId) {
      const fingerprint = navigator.userAgent + navigator.language + navigator.platform;
      const randomString = Math.random().toString(36).substr(2, 9);
      deviceId = 'visitor_' + btoa(fingerprint).substr(0, 10) + '_' + randomString;
        ...
        <div>
          ...
          <p className="text-2xl font-bold text-gray-800">
            {loading ? (
              ...
              title === 'Website Visitors' ? value.toLocaleString() : value
            )}
          </p>
          {description && (
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <section className="py-20 gradient-bg text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">Learn Web Development, Programming Languages Day by Day with Interactive Quizzes</p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">Our Learning Community</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <StatCard 
              ...
              description="Of interactive content"
            />
            <StatCard 
              ...
              description="Unique visitors joined"
            />
          </div>
        </div>
      </section>
...
//     let deviceId = localStorage.getItem('deviceId');
//     if (!deviceId) {
//       // Generate a unique device ID using browser fingerprint + random string
//       const fingerprint = navigator.userAgent + navigator.language + navigator.platform;
//       const randomString = Math.random().toString(36).substr(2, 9);
//       deviceId = 'visitor_' + btoa(fingerprint).substr(0, 10) + '_' + randomString;
//       localStorage.setItem('deviceId', deviceId);
...
//               <i className="fas fa-spinner fa-spin text-blue-500"></i>
//             ) : (
//               title === 'Total Users' ? value.toLocaleString() : value
//             )}
//           </p>
//           {description && (
//             <p className="text-xs text-gray-500 mt-1">{description}</p>
...
//               Start Learning
//             </a>
//             <a href="#contact" className="btn-primary bg-transparent border-2 border-white hover:bg-white hover:text-white-600">
//               Contact Me
//             </a>
//           </div>
//         </div>
